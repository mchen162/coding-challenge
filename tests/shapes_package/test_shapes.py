...
"""
    def test_right_triangle_raises_value_error_with_valid_hypotenuse(self):
        ...
        mock_height, mock_width, mock_hypotenuse = 3., 4., 5.
        mock_right_triangle = RightTriangle(height=mock_height, width=mock_width, hypotenuse=mock_hypotenuse)
        self.assertGreater(mock_right_triangle.hypotenuse, mock_right_triangle.height, "Supplied hypotenuse must be greater than height")
        self.assertGreater(mock_right_triangle.hypotenuse, mock_right_triangle.width, "Supplied hypotenuse must be greater than width")
